...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MYMESSAGE:
	{
		...
		Rectangle(hdc, wParam - 25, lParam - 25, wParam + 25, lParam + 25);
		MessageBox(hwnd, TEXT("알림"), TEXT("수신"), MB_OK);
		ReleaseDC(hwnd, hdc);
		return 0;
	}
	//윈도우 생성되었고, 화면에 안보인다.
...
int WINAPI _tWinMain(HINSTANCE hInst, HINSTANCE hprevInstance, LPTSTR cmdline, int showcmd)
{
	...
	HWND hwnd = CreateWindowEx(WS_EX_TOPMOST, TEXT("wb41"), TEXT("IPC 수신부"),
