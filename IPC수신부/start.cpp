...
INT_PTR CALLBACK DlgProc(HWND hdlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
	case WM_MYSHOW: return OnMYSHOW(hdlg, wParam, lParam);
	case WM_MYCOLOR: return OnMYCOLOR(hdlg, wParam, lParam);
	case WM_MYPOSITION: return OnMYPOSITION(hdlg, wParam, lParam);
	case WM_INITDIALOG: return OnInitDialog(hdlg);
	case WM_PAINT: return OnPaint(hdlg);
