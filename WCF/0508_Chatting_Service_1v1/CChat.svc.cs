...
namespace _0508_Chatting_Service_1v1
{
    ...
    public class CChat : IChat
    {
        ...
        public bool Join(string nickname, DateTime date)
        {
            ...
            lock (syncObj)
            {
                if (!Chatter.Contains(nickname))
                {
                    ...
                    SendMessage("UserEnter", nickname, "", date);
        ...
        {
            SendMessage("Receive", nickname, msg, date);
        }
        ...
        public void Leave(string nickname, DateTime date)
        {
            ...
            SendMessage("UserLeave", nickname, msg, date);
        }

        private void SendMessage(string msgType, string nickname, string msg, DateTime date)
        {
